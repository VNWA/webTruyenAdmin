...
class ProjectStylingController extends Controller
{
    ...
    {
        $data = Project::with('listImages')->where('id_category_project', 3)->with('categoryProject')->get();
        ...
        $trashCount = Project::where('id_category_project', 3)->onlyTrashed()->count();
    ...
    function showIndex()
    {
        ...
        return Inertia::render('ProjectStyling/Show', ['data' => $data, 'trashCountNumber' => $trashCount]);
    }

    function showTrash()
    {
        $data = Project::with('listImages')->where('id_category_project', 3)->onlyTrashed()->get();
        ...
        return Inertia::render('ProjectStyling/Trash', ['data' => $data, 'trashCount' => $trashCount]);
    }
    ...
    function showEdit($id)
    {
        ...
        return Inertia::render('ProjectStyling/Edit', ['data' => $data]);
    }
    function update(Request $rq, $id)
    {
        ...
        ListImage::where('tb', $tb)->where('id_tb', $id)->delete();
        foreach ($listSubImage as $key => $value) {
            ListImage::create([
                'tb' => $tb,
                'id_tb' => $id,
