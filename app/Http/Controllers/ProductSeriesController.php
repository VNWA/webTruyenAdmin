...
class ProductSeriesController extends Controller
{
    ...
    {
        $data = Product::where('id_category', 1)->with('episodes')->with('types')->with('year')->with('nation')->latest()->get();
        ...
        $trashCount = Product::where('id_category', 1)->onlyTrashed()->count();
    ...
    function showIndex()
    {
        ...
        return Inertia::render('ProductSeries/Show', ['data' => $data, 'trashCountNumber' => $trashCount]);
    }
    ...
    function showCreate()
    {
        ...
        return Inertia::render('ProductSeries/Create', ['listYear' => $listYear, 'listNation' => $listNation, 'listType' => $dataType]);
    }
    ...
    {
        $data = Product::where('id_category', 1)->with('types')->with('year')->with('nation')->find($id);
        ...
        return Inertia::render('ProductSeries/Edit', ['data' => $data, 'listYear' => $listYear, 'listNation' => $listNation, 'listType' => $dataType, 'dataTypeSelected' => $dataTypeSelected]);
    }
    ...
    function showTrash()
    {
        ...
        return Inertia::render('ProductSeries/Trash', ['data' => $data, 'trashCount' => $trashCount]);
    }
}
