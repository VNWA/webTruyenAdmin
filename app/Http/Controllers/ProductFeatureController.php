...
class ProductFeatureController extends Controller
{
    ...
    {
        $data = Product::where('id_category', 2)->with('episodes')->with('types')->with('year')->with('nation')->latest()->get();
        ...
        $trashCount = Product::where('id_category', 2)->onlyTrashed()->count();
    ...
    function showIndex()
    {
        ...
        return Inertia::render('ProductFeature/Show', ['data' => $data, 'trashCountNumber' => $trashCount]);
    }
    ...
    function showCreate()
    {
        ...
        return Inertia::render('ProductFeature/Create', ['listYear' => $listYear, 'listNation' => $listNation, 'listType' => $dataType]);
    }
    ...
    {
        $data = Product::where('id_category', 2)->with('types')->with('year')->with('nation')->find($id);
        ...
        return Inertia::render('ProductFeature/Edit', ['data' => $data, 'listYear' => $listYear, 'listNation' => $listNation, 'listType' => $dataType, 'dataTypeSelected' => $dataTypeSelected]);
    }
    ...
    function showTrash()
    {
        ...
        return Inertia::render('ProductFeature/Trash', ['data' => $data, 'trashCount' => $trashCount]);
    }
}
