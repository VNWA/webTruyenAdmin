...
<template>
    <AppLayout title="Sửa Meta SEO của Năm">

        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight ">
                Sửa Meta SEO của Năm
            </h2>
        </template>
        <div class="overflow-hidden  px-5 mb-3 ">
            <div class="w-100  p-1 flex justify-between items-center">
                <div class="  ">
                    <Link :href="route('Year')" class="text-dark-700 hover:text-purple-900 font-bold underline decoration-1">
