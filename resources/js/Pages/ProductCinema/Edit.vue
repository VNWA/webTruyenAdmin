...
<template>
    <AppLayout title="Sửa  truyện Chiếu Rạp">
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight ">
                Sửa truyện Chiếu Rạp
            </h2>
        </template>
        <div class="overflow-hidden  px-5 mb-3 ">
            <div class="w-100  p-1 flex justify-between items-center">
                <div class="  ">
                    <Link :href="route('ProductCinema')" class="text-dark-700 hover:text-purple-900 font-bold underline decoration-1">
            ...
            axios.post('', {
                ...
                .then((response) => {
                    if (response.data.error) {
                        ...
                        this.$inertia.visit(route('ProductCinema'));
